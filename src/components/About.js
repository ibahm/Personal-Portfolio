    ...
    return (
        <div data-aos="zoom-in-down" data-aos-duration="1000" className="about-container">
            <div className="about-text">
                ...
                <p className="about-desc1">I am a software enthusiast that loves to learn topics and display them through creative projects.
                 ...
                 <p className="about-desc2">At university, I had taken part in a multitude of projects demonstrating my understanding of <span>Java</span>. These projects included
