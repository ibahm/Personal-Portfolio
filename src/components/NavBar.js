...
const NavBar = () => {
    ...
    return (
        <div className="nav-container">
            ...
            <ul>
                <li className="about" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="600">
                    <Link to="about-container" spy={true} smooth={true} offset={-200} duration={500}>
                        <p>About</p>
                    </Link>    
                </li>
                <li className="projects" data-aos="fade-down" data-aos-duration="1200" data-aos-delay="600">
                    <Link to="projectlist-container" spy={true} smooth={true} offset={-200} duration={500}>
                        <p>Projects</p>
                    </Link>
                </li>
                <li className="contact" data-aos="fade-down" data-aos-duration="1400" data-aos-delay="600">
                    <Link to="contact-container" spy={true} smooth={true} offset={-200} duration={500}>
                        <p>Contact</p>
                    </Link>
                </li>
                <li>
                    <div data-aos="fade-down" data-aos-duration="1600" data-aos-delay="600">
                        <a className="nav-resume" href="./resources/ahmed-ahmed-cv.pdf" download>CV</a>
                    </div>
                </li>
            </ul>
